...
writetable(conf_data, "amazon_confusion_summary.csv")
writetable(ins_data, "amazon_insertion_summary.csv")
writetable(del_data, "amazon_deletion_summary.csv")
writetable(del_data, "amazon_substitution_summary.csv")
